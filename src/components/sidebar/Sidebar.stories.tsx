...
export const DevCenterWithApps = (args) => {
  const apps = [
    { name: 'Production', onClick() { args.onClickApp('App selected: Production'); setCurrentApp(this); } },
    { name: 'Staging', onClick() { args.onClickApp('App selected: Staging'); setCurrentApp(this); } },
    { name: 'Test App', onClick() { args.onClickApp('App selected: Test App'); setCurrentApp(this); } },
    { name: 'Dummy', onClick() { args.onClickApp('App selected: Dummy'); setCurrentApp(this); } }
  ];
